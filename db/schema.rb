...
ActiveRecord::Schema.define(version: 20150609131947) do
  ...
  create_table "host_fields", force: :cascade do |t|
    t.string   "name"
    t.string   "field_type"
    t.boolean  "required"
  ...
  add_index "host_fields", ["host_type_id"], name: "index_host_fields_on_host_type_id", using: :btree
  ...
  add_foreign_key "host_fields", "host_types"
end
